 ...
 * Grid ve Pivot template'leri için ortak header yapısı
 */
                ...
                <div class="d-flex justify-content-between align-items-center gap-2 mb-3">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="record-count-badge" style="background: #667eea; color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">
                            <strong><span id="totalRecords">0</span></strong> Kayıt
                        </span>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 flex-grow-1">
                        ...
                        <button class="btn btn-primary btn-sm grid-btn-reset" onclick="ArchiXReportsHeader.handleReset()" title="Sıfırla">
