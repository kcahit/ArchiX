...
public sealed class PasswordHistoryModel : PageModel
{
    ...
    [BindProperty(SupportsGet = true)]
    [Range(1, 100, ErrorMessage = "Kayýt sayýsý 1-100 aralýðýnda olmalý.")]
    [Display(Name = "Kayýt Sayýsý")]
    ...
    public async Task<IActionResult> OnGetAsync(CancellationToken ct)
    {
        ...
        {
            ModelState.AddModelError(nameof(Query), "Geçerli bir kullanýcý ID girin.");
