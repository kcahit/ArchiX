...
namespace ArchiX.Library.Web.Templates.Modern.Pages.Raporlar
{
    public class KombineModel : PageModel
    {
        ...
        public KombineModel(IReportDatasetExecutor executor, IReportDatasetOptionService optionsSvc)
        {
            _executor = executor;
        ...
        public async Task OnGetAsync([FromQuery] int? reportDatasetId, CancellationToken ct)
        {
            ...
            // fail-closed: Approved olmayan dataset seçilirse çalıştırma yok
