...
{
    /// <inheritdoc />
    public partial class CleanCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Parameters",
                columns: new[] { "Id", "CreatedBy", "Description", "Group", "IsProtected", "Key", "LastStatusBy", "ParameterDataTypeId", "StatusId", "Template", "UpdatedAt", "UpdatedBy", "Value" },
                values: new object[] { 1, 0, "İkili doğrulama varsayılan kanal ve seçenekleri", "TwoFactor", false, "Options", 0, 15, 3, "{\n  \"defaultChannel\": \"Sms\",\n  \"channels\": {\n    \"Sms\": { \"codeLength\": 6, \"expirySeconds\": 300 },\n    \"Email\": { \"codeLength\": 6, \"expirySeconds\": 300 },\n    \"Authenticator\": { \"digits\": 6, \"periodSeconds\": 30, \"hashAlgorithm\": \"SHA1\" }\n  }\n}", null, null, "{\n  \"defaultChannel\": \"Sms\"\n}" });
